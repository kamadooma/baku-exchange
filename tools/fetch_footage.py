...
# 銘柄 → Pexels 検索キーワード
IMG_QUERY = {
  "2COM": "storm clouds parting sunbeams",
  "AFFAIR": "lovers silhouette embrace dim light",
  "AIBC": "data center server technology",
  "AIJOB": "robot arm factory assembly line worker",
  "ALIEN": "flying saucer ufo night sky",
  "ALONE": "person alone window solitude",
  "ANIMAL": "dog owner talking pet bond",
  "ARMAG": "apocalyptic storm dark dramatic sky",
  "ASTER": "asteroid meteor space impact",
  "ASTRO": "astronaut spacewalk stars orbit",
  "ATLANT": "sunken city underwater ruins ocean",
  "BALLER": "soccer stadium goal celebration",
  "BILLION": "luxury private jet billionaire mansion",
  "BIRDWISH": "bird flying freedom sky",
  "BLKOUT": "city skyline darkness power outage",
  "BODY": "mirror reflection fitness body toned",
  "CALL": "craftsman hands workshop passion work",
  "CALM": "meditation calm nature peaceful",
  "CHASE": "running silhouette night dark street",
  "CHILD": "child playing carefree sunlight",
  "CHOSEN": "sword in stone knight legend",
  "CINDER": "ballgown glass slipper fairytale",
  "CLASS": "red flag crowd waving",
  "CLEAN": "gavel courtroom justice scales",
  "CONF": "confident person standing tall success",
  "CRSH": "stock market crash trading floor panic",
  "CRUSH": "couple holding hands sunset romance",
  "CURE": "vaccine injection medical hope",
  "CUTE": "selfie girl phone social media",
  "DATALOSS": "glitching computer screen data corruption",
  "DEAD": "antique rotary phone ringing dark room",
  "DEADCAT": "cat sleeping sunlight window",
  "DEBT": "unpaid bills stress paperwork",
  "DEMO": "ballot box voting hands",
  "DISARM": "anti-nuclear protest peace march",
  "DONTWAKE": "girl sleeping enchanted forest fairytale",
  "DROWN": "woman submerged underwater dress floating",
  "EDEN": "tropical garden paradise lush greenery",
  "EDU": "children classroom school learning global",
  "ELOPE": "couple running road adventure",
  "ENDDEM": "protest demonstration crowd",
  "ENDEM": "empty parliament chamber dark dramatic",
  "ENHANCE": "robotic arm prosthetic hand",
  "ENLIGHT": "buddha statue meditation temple light",
  "ENRGY": "solar panels wind turbines clean energy",
  "ERTH2": "distant planet space telescope stars",
  "ETLIF": "starry night sky mysterious lights",
  "EXAM": "clock ticking exam desk classroom",
  "EXTN": "extinct animal skeleton museum dark",
  "FAIR": "gold coins scale balance",
  "FALL": "person falling through clouds motion blur",
  "FALSE": "person waking bed disoriented blurry",
  "FAME": "red carpet paparazzi flashing cameras",
  "FASC": "soldiers marching formation military uniform",
  "FIRE": "hammock beach relaxation vacation",
  "FLORIST": "flower market colorful bouquets",
  "FLY": "person flying sky freedom aerial",
  "FLYCR": "flying car futuristic city sky",
  "FOLLOW": "smartphone notifications likes screen",
  "FOOD": "cracked dry earth drought famine",
  "FORESEE": "crystal ball fortune teller mystic",
  "FORGETEX": "rain window lonely silhouette",
  "FREE": "money cash falling wealth freedom",
  "FRND": "friends laughing together sunset",
  "FUNRL": "funeral flowers casket cemetery",
  "GEQ": "women marching protest crowd",
  "GOLDEN": "golden light nostalgic vintage glow",
  "GROW": "skyscraper city urban growth",
  "HAREM": "silk cushions palace opulent",
  "HLTH": "person running healthy sunrise vitality",
  "HOME": "cozy house family home exterior",
  "HOME2": "countryside road home path",
  "IMMO": "fountain of youth ethereal light",
  "INHERIT": "antique chest gold coins",
  "ISEKAI": "magic portal glowing doorway light",
  "JACK": "lottery balls jackpot winner",
  "JPSK": "tsunami wave ocean destruction",
  "JUDG": "dramatic stormy sky religious painting",
  "LEAK": "hacker code dark screen data",
  "LOOP": "clock hands spinning blurred motion",
  "LOOPTALK": "abstract spiral loop hypnotic motion",
  "LOSTHOME": "abandoned house overgrown vines decay",
  "LOVE": "couple kissing romantic sunset",
  "MARS": "mars planet red surface",
  "MARX": "red flag hammer sickle statue",
  "MEETLOVE": "couple silhouette sunset embrace",
  "MESSI": "divine light rays clouds heaven",
  "MIRR": "shadowy reflection figure mirror night",
  "MOTE": "mirror reflection glamour makeup",
  "MUTE": "dark shadow figure bedroom night",
  "NAKED": "silhouette person spotlight exposed stage",
  "NEEDED": "hands reaching helping comfort",
  "NOANX": "peaceful meditation sunrise silhouette",
  "NODISC": "civil rights march crowd protest",
  "NOHGR": "abundant harvest table family meal",
  "NOPOV": "poverty slum street children",
  "NOWAKE": "person sleeping bed dark shadow moonlight",
  "NOWAR": "white dove flying sky",
  "NOWORK": "hammock beach relaxing sunset",
  "NUKE": "nuclear mushroom cloud explosion sky",
  "OIL": "gas station long line vintage 1970s",
  "OSHI": "concert crowd hands phone lights stage",
  "PANDM": "pandemic mask protective",
  "PARENT": "vintage family portrait old photograph",
  "PERP": "gears clockwork mechanism spinning",
  "PREZ": "podium flags speech microphone",
  "PROG": "steam train tracks vintage",
  "PWD": "blurred computer login screen error",
  "QUAKE": "earthquake rubble destroyed city street",
  "QUITJOB": "exhausted office worker slumped desk",
  "REASON": "candlelight library books study",
  "REBORN": "butterfly emerging cocoon wings",
  "REDO": "hourglass sand flowing time",
  "REUNI": "silhouette couple embrace sunset",
  "REUNION": "balloons party nostalgia celebration",
  "REVENGE": "clenched fist dramatic shadow",
  "RIVAL": "boxers face off ring",
  "ROADEXT": "long straight highway vanishing point",
  "ROBOT": "humanoid robot android dark portrait",
  "ROCK": "electric guitar concert lights",
  "ROOMS": "long corridor doors endless hallway",
  "SCIFUT": "futuristic city neon skyline night glow",
  "SELF": "fragmented mirror reflection face",
  "SEX": "couple embrace silhouette candlelight",
  "SHANGRI": "misty mountains monastery valley",
  "SING": "humanoid robot android",
  "SINGER": "microphone spotlight stage performance",
  "SKYFALL": "dark storm clouds rolling apocalyptic",
  "SLEEP": "sleeping peaceful morning light",
  "SLEEPIN": "alarm clock bed morning",
  "SOMEONE": "silhouette person facing bright spotlight",
  "SOUL": "couple holding hands sunset",
  "SOULIM": "glowing light ascending ethereal",
  "STONE": "glowing stone alchemy laboratory",
  "STOPGW": "wind turbine renewable energy",
  "SUMMER": "sun flare beach waves golden light",
  "SUNKCITY": "city reflection water twilight surreal",
  "SURV": "cctv camera surveillance dark corridor",
  "SUST": "solar panels wind turbines",
  "TALNT": "spotlight piano hands playing",
  "TEETH": "cracked teeth falling out closeup",
  "TENNO": "golden throne crown palace",
  "TIME": "clock spinning surreal blur",
  "TOKOYO": "misty forest torii gate",
  "TOWER": "skyscraper tall building city",
  "TRVL": "airplane window clouds flight",
  "UBI": "open hands receiving falling money",
  "UNDO": "torn letter vintage paper",
  "UTOPIA": "futuristic city skyline utopia",
  "WEDLOCK": "wedding veil bride solemn vintage",
  "WPRE": "confident businesswoman suit portrait",
  "WREV": "crowd protest flags smoke",
  "YOUTH": "young woman golden light flowers portrait",
}
