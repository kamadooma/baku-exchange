  ...
  (function() {
    ...
    const NAR = [
      ...
      { jp:"全身を楽にして。力を抜いて——目を閉じて。",
        en:"Let the whole body soften. Release the tension — and let the eyes close." },
      { jp:"鼻から、ゆっくりと息を吸って。もっと深く。さらに深く。",
        en:"Draw the breath in through the nose — slowly. Deeper. Deeper still." },
      { jp:"口から、吐き切ります。空になるまで。",
        en:"And release it through the mouth — all of it, until you are empty." },
      { jp:"もう一度。吸って……吐いて。すべてを手放して。",
        en:"Once more. Breathing in… and out. Letting everything go." },
      { jp:"あなたの夢は、まだ、ここにあります。",
        en:"Your dream is still here." },
      { jp:"ひとつ、思い浮かべてください。手放したい夢を。あるいは、悪夢を。",
        en:"Bring it to mind — the dream you wish to release. Or the nightmare." },
      { jp:"——それはいつから、あなたのものでしたか？",
        en:"— When did it become yours?" },
      { jp:"——それは、いつ、あなたのもとに来ましたか？",
        en:"— When did it come to you?" },
      { jp:"子どもの頃から、夢を持つことは良いことだと教わってきました。けれど、夢はそれ自体のために抱えるものではありません。それは、ほんとうに、あなたのものでしたか？",
        en:"As children, we were taught that to hold a dream was a good thing. But a dream is not something to be carried for its own sake. Was it — truly — ever yours?" },
      { jp:"誰かが望んでいたものを、あなたも望むようになっただけかもしれません。あるいは——あなたを怖がらせるものかもしれません。",
        en:"Perhaps it was something another wanted, and you only learned to want it too. Or perhaps — it is something that frightens you." },
      { jp:"おそれと、ほんとうの望みは、ひとつのコインの表と裏。",
        en:"Fear and true desire are two faces of a single coin." },
      { jp:"もう一度、自分に問いかけてください。これは、もう必要のない夢ですか？",
        en:"So ask yourself, once more: is this a dream you no longer need?" },
      { jp:"悪夢を、手放してください。もっと軽くなってください。",
        en:"Let the nightmare go. Let yourself grow lighter." },
      { jp:"息を、ゆっくり、吐いてください。",
        en:"Breathe out — slowly.", pause:1200 },
      { jp:"息を、ゆっくり、吐いてください。",
        en:"Breathe out — slowly.", pause:1200 },
      { jp:"息を、ゆっくり、吐いてください。",
        en:"Breathe out — slowly.", pause:1200 },
      { jp:"その夢のかたちを、感じてみてください。重さ。温もり。輪郭。",
        en:"Sense its shape. Its weight. Its warmth. Its edges." },
      { jp:"胸の中心から——ゆっくりと——持ち上げます。呼吸に乗せて、安らかに。",
        en:"From the centre of the chest — slowly — lift it. And let it rest upon your breath." },
      { jp:"そして今——静かに、ゆっくりと——夢を話してください。ありのままに。それが何であるか、だけを。",
        en:"And now — gently, slowly — speak your dream. Plainly. Only what it is…", final:true },
    ];
    ...
    const VISUAL_NOUNS = {
      ...
      // ── 動物（追加・単漢字は複合形で登録）──
      // 象（単漢字は弾かれるので複合形で）
      "ゾウ":"elephant","ぞうさん":"elephant","大きな象":"elephant","象さん":"elephant",
      "アフリカゾウ":"elephant","インドゾウ":"elephant","象が":"elephant","elephant":"elephant",
      // 馬
      "馬が":"horse","うま":"horse","ウマ":"horse","horse":"horse","白馬":"horse","黒馬":"horse",
      // 鹿
      "鹿が":"deer","しか":"deer","シカ":"deer","deer":"deer","トナカイ":"deer","となかい":"deer","reindeer":"deer",
      // その他単漢字動物の複合形
      "猫が":"cat_cute","猫の":"cat_cute","ネコが":"cat_cute","ねこ":"cat_cute",
      "犬が":"dog_happy","犬の":"dog_happy","イヌが":"dog_happy","いぬ":"dog_happy",
      "牛が":"cow","牛の":"cow","うし":"cow","ウシ":"cow","cow":"cow",
      "豚が":"pig","豚の":"pig","ぶた":"pig","ブタ":"pig","pig":"pig",
      "猿が":"monkey","猿の":"monkey","さる":"monkey","サル":"monkey","monkey":"monkey","ゴリラ":"gorilla",
      "虎が":"tiger","虎の":"tiger","とら":"tiger","トラ":"tiger","tiger":"tiger",
      "鳥が":"eagle","鳥の":"eagle","とり":"eagle","鳥":"eagle",
      "魚が":"fish_school","魚の":"fish_school","さかな":"fish_school","fish":"fish_school",
      // キツネ・ウサギ
      "キツネ":"fox","きつね":"fox","狐":"fox","fox":"fox",
      "ウサギ":"rabbit","うさぎ":"rabbit","兎":"rabbit","rabbit":"rabbit","ぴょんぴょん":"rabbit",
      ...
      // ── Professions ──
      "シェフ":"chef_cooking","料理人":"chef_cooking","chef":"chef_cooking","コック":"chef_cooking",
      "画家":"artist_painting","芸術家":"artist_painting","artist":"artist_painting","アーティスト":"artist_painting",
      "音楽家":"musician_stage","ミュージシャン":"musician_stage","musician":"musician_stage",
      "アスリート":"athlete_running","スポーツ選手":"athlete_running","athlete":"athlete_running",
      "兵士":"soldier_field","軍人":"soldier_field","soldier":"soldier_field","兵隊":"soldier_field",
      "スパイ":"spy_dark","spy dark":"spy_dark","秘密工作員":"spy_dark",
      "海賊":"pirate_ship","かいぞく":"pirate_ship","pirate":"pirate_ship",
      "カウボーイ":"cowboy_horse","cowboy":"cowboy_horse",
      "ダイバー":"diver_underwater","潜水士":"diver_underwater","diver":"diver_underwater",
      "ボクサー":"boxer_ring","ボクシング":"boxer_ring","boxer":"boxer_ring",
      "ダンサー":"dancer_stage","踊り子":"dancer_stage","dancer":"dancer_stage","バレリーナ":"dancer_stage",
      "手品師":"magician_stage","マジシャン":"magician_stage","magician":"magician_stage","奇術師":"magician_stage",
      "神父":"priest_church","牧師":"priest_church","priest":"priest_church",
      "錬金術師":"alchemist","れんきんじゅつし":"alchemist","alchemist":"alchemist",
      "宇宙飛行士の月":"astronaut_moon","月面宇宙飛行士":"astronaut_moon","astronaut moon":"astronaut_moon",
      "アクロバット":"acrobat_circus","サーカス":"acrobat_circus","acrobat":"acrobat_circus",
      "猟師":"hunter_forest","ハンター":"hunter_forest","hunter":"hunter_forest",
      "僧侶":"monk_temple","お坊さん":"monk_temple","monk":"monk_temple","修道士":"monk_temple",
      "鍛冶屋":"blacksmith","かじや":"blacksmith","blacksmith":"blacksmith",
      // ── Social Situations ──
      "パーティ":"party_celebration","party":"party_celebration","お祝い":"party_celebration","宴会":"party_celebration",
      "葬式の暗さ":"funeral_dark","dark funeral":"funeral_dark","黒い葬儀":"funeral_dark",
      "病院の待合室":"hospital_waiting","びょういんまちあいしつ":"hospital_waiting","hospital waiting":"hospital_waiting",
      "入学初日":"first_day_school","学校の初日":"first_day_school","first day school":"first_day_school",
      "森で迷子":"lost_forest_path","くらいもりでまいご":"lost_forest_path","lost in forest":"lost_forest_path",
      "泳ぐ夢":"swimming_ocean","ocean swimming":"swimming_ocean","海を泳ぐ":"swimming_ocean",
      "壁をのぼる":"climbing_wall","岩を登る":"climbing_wall","climbing wall":"climbing_wall",
      "脱獄":"prison_escape","だつごく":"prison_escape","prison escape":"prison_escape",
      "嵐の避難":"storm_shelter","あらしのひなん":"storm_shelter","storm shelter":"storm_shelter",
      "宝探し":"treasure_hunt","たからさがし":"treasure_hunt","treasure hunt":"treasure_hunt",
      "幽霊屋敷の入口":"haunted_house_enter","おばけやしきのとびら":"haunted_house_enter","haunted house":"haunted_house_enter",
      "エレベーターに閉じ込め":"elevator_stuck","えれべーたーにとじこめ":"elevator_stuck","stuck elevator":"elevator_stuck",
      "砂に沈む":"quicksand_sink","流砂に沈":"quicksand_sink","quicksand sink":"quicksand_sink",
      "鏡の迷路":"mirror_maze","かがみのめいろ":"mirror_maze","mirror maze":"mirror_maze",
      "砂漠を歩く":"desert_walk","砂漠の一人":"desert_walk","alone desert":"desert_walk",
      // ── Emotions & States ──
      "幸福感":"euphoria","こうふくかん":"euphoria","euphoria":"euphoria","陶酔":"euphoria",
      "郷愁":"melancholy_rain","きょうしゅう":"melancholy_rain","melancholy":"melancholy_rain",
      "デジャブ":"deja_vu","既視感":"deja_vu","deja vu":"deja_vu",
      "時間が凍る":"time_freeze","じかんがこおる":"time_freeze","time freeze":"time_freeze","停止した世界":"time_freeze",
      "透明人間":"invisibility_person","とうめいにんげん":"invisibility_person","invisible person":"invisibility_person",
      "飛ぶ喜び":"flying_euphoria","とぶよろこび":"flying_euphoria","flying euphoria":"flying_euphoria",
      "暗闇に落ちる":"falling_void","あんやみにおちる":"falling_void","falling void":"falling_void",
      "見られている感覚":"being_watched","みられているかんかく":"being_watched","being watched":"being_watched",
      "ガラスに閉じ込め":"trapped_glass","がらすにとじこめ":"trapped_glass","trapped glass":"trapped_glass",
      "走れない夢":"running_slow","はしれないゆめ":"running_slow","running slow":"running_slow","足が動かない":"running_slow",
      // ── Surreal Dream Concepts ──
      "さかさまの街":"upside_down_city","逆さまの都市":"upside_down_city","upside down city":"upside_down_city",
      "無限階段":"infinite_stairs","むげんかいだん":"infinite_stairs","infinite staircase":"infinite_stairs",
      "溶ける時計":"melting_clock","とける時計":"melting_clock","melting clock":"melting_clock",
      "巨人と都市":"giant_in_city","きょじんとし":"giant_in_city","giant in city":"giant_in_city",
      "空に浮かぶドア":"door_in_sky","そらのドア":"door_in_sky","floating door sky":"door_in_sky",
      "水浸しの部屋":"underwater_room","みずびたしのへや":"underwater_room","flooded room":"underwater_room",
      "消える道":"path_disappears","きえるみち":"path_disappears","path disappears":"path_disappears",
      "空に浮かぶ家":"house_floating","そらにうかぶいえ":"house_floating","floating house":"house_floating",
      "空の巨大な目":"eye_in_sky","そらのきょだいなめ":"eye_in_sky","eye in sky":"eye_in_sky",
      "歯が抜けるアニメ":"teeth_falling_anim","はがぬけるゆめ":"teeth_falling_anim","teeth falling dream":"teeth_falling_anim",
      "動く影":"shadow_moves","うごくかげ":"shadow_moves","shadow moves":"shadow_moves",
      "水が溢れる":"water_everywhere","みずがあふれる":"water_everywhere","water everywhere":"water_everywhere",
      "溶ける顔":"faces_melting","とけるかお":"faces_melting","faces melting":"faces_melting",
      "庭の迷路":"garden_maze","にわのめいろ":"garden_maze","garden maze":"garden_maze",
      "霧の街":"fog_city_dark","きりのまち":"fog_city_dark","foggy city":"fog_city_dark",
      // ── Nature Extremes ──
      "凍った世界":"ice_world","こおったせかい":"ice_world","frozen world":"ice_world",
      "燃える世界":"fire_world","もえるせかい":"fire_world","world on fire":"fire_world",
      "迫る洪水":"flood_rising","せまるこうずい":"flood_rising","flood rising":"flood_rising",
      "隕石の空":"asteroid_sky","いんせきのそら":"asteroid_sky","asteroid sky":"asteroid_sky",
      "二つの太陽":"double_sun","ふたつのたいよう":"double_sun","double sun":"double_sun","二重太陽":"double_sun",
      "血の月":"blood_moon","ちのつき":"blood_moon","blood moon":"blood_moon","赤い月":"blood_moon",
      "嵐の中の船":"storm_sea_ship","あらしのなかのふね":"storm_sea_ship","storm ship":"storm_sea_ship",
      "陸上竜巻":"tornado_path","りくじょうたつまき":"tornado_path","tornado path":"tornado_path",
      "溶岩の川":"lava_river","ようがんのかわ":"lava_river","lava river":"lava_river",
      "氷河":"glacier","ひょうが":"glacier","glacier":"glacier","グレイシャー":"glacier",
      "沼地":"swamp_dark","ぬまち":"swamp_dark","swamp":"swamp_dark","湿地帯":"swamp_dark",
      "崖の端":"cliff_edge","がけのはし":"cliff_edge","cliff edge":"cliff_edge","断崖の端":"cliff_edge",
      "巨大滝":"waterfall_massive","きょだいたき":"waterfall_massive","massive waterfall":"waterfall_massive",
      "水中の森":"underwater_forest","すいちゅうのもり":"underwater_forest","underwater forest":"underwater_forest",
      // ── Dream Objects & Symbols ──
      "赤いドア":"red_door","あかいどあ":"red_door","red door":"red_door",
      "壊れた時計":"broken_watch","こわれたとけい":"broken_watch","broken watch":"broken_watch","止まった時計":"broken_watch",
      "浮かぶ本":"floating_book","うかぶほん":"floating_book","floating book":"floating_book",
      "光る球":"glowing_orb","ひかるたま":"glowing_orb","glowing orb":"glowing_orb","光の玉":"glowing_orb",
      "古い地図":"ancient_map","ふるいちず":"ancient_map","ancient map":"ancient_map",
      "ひび割れた大地":"cracked_earth","ひびわれただいち":"cracked_earth","cracked earth":"cracked_earth",
      "コマ":"spinning_top","こま":"spinning_top","spinning top":"spinning_top","回るコマ":"spinning_top",
      "オルゴール":"music_box","おるごーる":"music_box","music box":"music_box",
      "空の鳥かご":"empty_birdcage","からのとりかご":"empty_birdcage","empty birdcage":"empty_birdcage",
      "暗い蝶":"butterfly_dark","くらいちょうちょ":"butterfly_dark","dark butterfly":"butterfly_dark",
      "赤い糸":"red_thread","あかいいと":"red_thread","red thread fate":"red_thread","運命の赤い糸":"red_thread",
      "壊れた砂時計":"broken_hourglass","こわれたすなどけい":"broken_hourglass","broken hourglass":"broken_hourglass",
      "落ちたお面":"mask_face","おちたおめん":"mask_face","mask on floor":"mask_face",
      "子供のおもちゃ一人":"child_toy_alone","こどものおもちゃひとり":"child_toy_alone","child toy alone":"child_toy_alone",
      "スノードーム":"snow_globe","すのーどーむ":"snow_globe","snow globe":"snow_globe",
      // ── Food ──
      "湯気のお椀":"steaming_bowl","ゆげのおわん":"steaming_bowl","steaming bowl":"steaming_bowl",
      "暗いバースデーケーキ":"birthday_cake_dark","くらいばーすでーけーき":"birthday_cake_dark","dark birthday cake":"birthday_cake_dark",
      "腐った食べ物":"rotten_food","くさったたべもの":"rotten_food","rotten food":"rotten_food",
      "豪華な宴席":"banquet_table","ごうかなえんせき":"banquet_table","banquet table":"banquet_table",
      "空のお皿":"empty_plate","からのおさら":"empty_plate","empty plate":"empty_plate",
      "禁断の果実":"forbidden_fruit","きんだんのかじつ":"forbidden_fruit","forbidden fruit":"forbidden_fruit",
      // ── Body ──
      "歯が抜ける口":"falling_teeth_mouth","はがぬけるくち":"falling_teeth_mouth","teeth falling mouth":"falling_teeth_mouth",
      "抜け落ちる髪":"hair_falling","ぬけおちるかみ":"hair_falling","hair falling":"hair_falling","髪が抜ける":"hair_falling",
      "目が開く":"eye_opening","めがひらく":"eye_opening","eye opening":"eye_opening",
      "暗闇に伸びる手":"hand_reaching_dark","くらやみにのびるて":"hand_reaching_dark","hand reaching dark":"hand_reaching_dark",
      "鏡に映る別人":"reflection_different","かがみにうつるべつじん":"reflection_different","different reflection":"reflection_different",
      "水に浮かぶ体":"body_floating_water","みずにうかぶからだ":"body_floating_water","body floating water":"body_floating_water",
      "心電図モニター":"heartbeat_monitor","しんでんずもにたー":"heartbeat_monitor","heartbeat monitor":"heartbeat_monitor",
      "骨格レントゲン":"bones_xray","こっかくれんとげん":"bones_xray","bones xray":"bones_xray",
      "無音の叫び":"scream_silent","むおんのさけび":"scream_silent","silent scream":"scream_silent",
      "金縛り":"paralyzed_bed","かなしばり":"paralyzed_bed","sleep paralysis":"paralyzed_bed","体が動かない":"paralyzed_bed",
      // ── Japanese Cultural ──
      "タヌキ":"tanuki_forest","たぬき":"tanuki_forest","狸":"tanuki_forest","raccoon dog":"tanuki_forest",
      "キツネのお面":"kitsune_mask","きつねのおめん":"kitsune_mask","fox mask":"kitsune_mask","狐の面":"kitsune_mask",
      "雪女":"yuki_onna","ゆきおんな":"yuki_onna","snow woman japanese":"yuki_onna",
      "赤鬼":"oni_demon_red","あかおに":"oni_demon_red","red oni":"oni_demon_red","鬼":"oni_demon_red","おに":"oni_demon_red",
      "侍の戦い":"samurai_battle","さむらいのたたかい":"samurai_battle","samurai battle":"samurai_battle",
      "日本の幽霊":"japanese_ghost","にほんのゆうれい":"japanese_ghost","japanese ghost":"japanese_ghost","白い幽霊":"japanese_ghost",
      "お祭り":"festival_night","おまつり":"festival_night","japanese festival":"festival_night","縁日":"festival_night",
      "夕焼けの鳥居":"torii_sunset","ゆうやけのとりい":"torii_sunset","torii sunset":"torii_sunset",
      "禅の庭":"zen_garden","ぜんのにわ":"zen_garden","zen garden":"zen_garden","石庭":"zen_garden",
      "盆栽":"bonsai_tree","ぼんさい":"bonsai_tree","bonsai":"bonsai_tree","盆栽の木":"bonsai_tree",
      "折り鶴":"paper_crane","おりづる":"paper_crane","origami crane":"paper_crane","折り紙":"paper_crane",
      "抜刀":"katana_drawn","ばっとう":"katana_drawn","drawn sword":"katana_drawn","刀を抜く":"katana_drawn",
      // ── Technology & Modern ──
      "多くの画面":"screen_many","おおくのがめん":"screen_many","many screens":"screen_many","監視モニター":"screen_many",
      "アルゴリズム":"algorithm_visual","あるごりずむ":"algorithm_visual","algorithm visual":"algorithm_visual","コードが流れる":"algorithm_visual",
      "VR":"vr_headset","仮想現実":"vr_headset","virtual reality":"vr_headset","ヴァーチャルリアリティ":"vr_headset",
      "ロボットの目":"robot_eye","ろぼっとのめ":"robot_eye","robot eye":"robot_eye",
      "光るキーボード":"keyboard_glow","ひかるきーぼーど":"keyboard_glow","keyboard glow":"keyboard_glow",
      "監視カメラの街":"city_surveillance","かんしかめらのまち":"city_surveillance","city surveillance":"city_surveillance",
      "監視カメラの目":"drone_eye","ドローンの目":"drone_eye","drone eye":"drone_eye","ドローン監視":"drone_eye",
      "核の輝き":"nuclear_glow","原子力の光":"nuclear_glow","nuclear glow":"nuclear_glow",
      "廃墟都市":"broken_city","はいきょとし":"broken_city","ruined city":"broken_city","崩壊した都市":"broken_city",
      "未来の廃墟":"future_ruins","みらいのはいきょ":"future_ruins","future ruins":"future_ruins","テクノロジーの廃墟":"future_ruins",
    };
    ...
    const JP_NOUN_EN = {
      ...
      // 動物（JP_NOUN_ENで確実にヒット）
      "ゾウ":"elephant","ぞう":"elephant","ぞうさん":"elephant","大きな象":"elephant","象さん":"elephant",
      "ライオン":"lion","らいおん":"lion","lion":"lion",
      "トラ":"tiger","とら":"tiger","tiger":"tiger",
      "クマ":"bear","くま":"bear","グリズリー":"bear","bear":"bear",
      "オオカミ":"wolf","おおかみ":"wolf","狼":"wolf","wolf":"wolf",
      "キリン":"giraffe","きりん":"giraffe","giraffe":"giraffe",
      "サイ":"rhinoceros","さい":"rhinoceros","rhinoceros":"rhinoceros",
      "カバ":"hippo","かば":"hippo","hippo":"hippo",
      "チンパンジー":"gorilla","ちんぱんじー":"gorilla","ゴリラ":"gorilla","gorilla":"gorilla",
      "パンダ":"panda","ぱんだ":"panda","熊猫":"panda","panda":"panda",
      "コアラ":"koala","こあら":"koala","koala":"koala",
      "カンガルー":"kangaroo","かんがるー":"kangaroo","kangaroo":"kangaroo",
      "シマウマ":"zebra","しまうま":"zebra","zebra":"zebra",
      "ペンギン":"penguin_cute","ぺんぎん":"penguin_cute","penguin":"penguin_cute",
      "サメ":"shark","さめ":"shark","shark":"shark",
      "クジラ":"whale","くじら":"whale","whale":"whale",
      "イルカ":"dolphin","いるか":"dolphin","dolphin":"dolphin",
      "タコ":"octopus","たこ":"octopus","octopus":"octopus",
      "ネコ":"cat_cute","ねこ":"cat_cute","猫":"cat_cute","cat":"cat_cute",
      "イヌ":"dog_happy","いぬ":"dog_happy","犬":"dog_happy","dog":"dog_happy",
      "ウサギ":"rabbit_cute","うさぎ":"rabbit_cute","rabbit":"rabbit_cute",
      "カエル":"frog","かえる":"frog","frog":"frog",
      "ヘビ":"snake","へび":"snake","蛇":"snake","snake":"snake",
      "ワニ":"crocodile","わに":"crocodile","crocodile":"crocodile",
      "ピエロ":"clown","ぴえろ":"clown","道化師":"clown","clown":"clown",
      // 乗り物
